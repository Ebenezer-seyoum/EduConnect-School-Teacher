<?php
// Start session safely and only once
if (session_status() === PHP_SESSION_NONE) {
  session_start();
}
//error_reporting(0);
// Use require_once to avoid redeclarations
require_once '../Edu-Connect/connection/connection.php';
require_once '../Edu-Connect/connection/function.php';
?>
<!doctype html>
<html lang="en">
...
<head>
  ...
  <style>
    body.auth-bg {
      /* Use provided PNG as the background with a solid fallback color */
      background-color: #eef2f7;
      /* fallback color */
      background-image: url('login/assets/img/login_bg.png');
